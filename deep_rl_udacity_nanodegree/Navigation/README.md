...
- `dqn_agent.py`:  Agent class that interacts with and learns from the environment 
- `model.py`: Q-network class used to map state to action values 
- `report.pdf`: Report explaining the solution, learnings and future work 
...
4. To load and play a trained RL agent, here are the steps:

    - DQN: 
        - Load checkpoint dqn.pth for loading the trained model. 
        - Choose qnetwork = 'QNetwork' when instantiating the agent object
        - Set algo_type='dqn'

    - Double DQN:
        - Load checkpoint ddqn.pth for loading the trained model. 
        - Choose qnetwork = 'QNetwork' when instantiating the agent object
        - Set algo_type='ddqn'

    - Dueling DQN: 
        - Load checkpoint dueling_dqn.pth for loading the trained model. 
        - Choose qnetwork = 'DuelingQNetwork' when instantiating the agent object
        - Set algo_type='ddqn'
