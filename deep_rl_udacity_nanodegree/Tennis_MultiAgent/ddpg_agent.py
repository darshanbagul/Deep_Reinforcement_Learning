...
class DDPGAgents():
	...
	def __init__(self, state_size, action_size, config):
		...
		self.actor_optimizer = getattr(optim, config.optimizer_actor["type"])(
			self.actor_local.parameters(), 
			betas=tuple(config.optimizer_actor["betas"]), 
				**config.optimizer_actor["params"])
		...
		self.critic_optimizer = getattr(optim, config.optimizer_critic["type"])(
			self.critic_local.parameters(), 
			betas=tuple(config.optimizer_critic["betas"]), 
				**config.optimizer_critic["params"])
